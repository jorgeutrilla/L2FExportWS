...
namespace API.App_Start
{
    ...
    public sealed class ApiConfig
    {
        ...
        /// Auth config.
        /// </summary>        
        public ApiConfig ConfigureJWTAuth()
        {
            // Configure the db context and user manager and role manager to use a single instance per request
            _app.CreatePerOwinContext(API.Model.FarmaContext.Create);
            _app.CreatePerOwinContext<FarmaUserManager>(FarmaUserManager.Create);
            ...
            OAuthOptions = new OAuthAuthorizationServerOptions
            {
                ...
                Provider = new OAuthProvider.OAuthProvider(PublicClientId),
